  ...
  return (
    <div className="main-div">
      ...
      <Card
        ...
        description="Rectangular resin frame with a photo and real preserved flowers."
        image={images[2]}
        button="Add to Cart"
        buttonTwo="View More"
      />
      ...
      />
      <Card
        title="Table Name plate"
        description="Transparent name plate in a rectangle shape with different sizes."
        image={images[4]}
        button="Add to Cart"
        buttonTwo="View More"
      />
